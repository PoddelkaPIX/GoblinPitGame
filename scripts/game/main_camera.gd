...
@export var _indent: Vector3 = Vector3(0, 8, 2)

@export var _camera_speed = 0.3

@export var _is_follow_cursor = false
...
func _move_to_target_position() -> void:
	...
	var dir: Vector3 = global_transform.origin.lerp(target_pos + _indent, _camera_speed)
